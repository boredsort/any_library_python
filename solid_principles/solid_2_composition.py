...
not_a_robot_authorizer.verify_code('40044')
payment_processor = PaypalPaymentProcessor("batman@gmail.com", not_a_robot_authorizer)
not_a_robot_authorizer.not_a_robot()
payment_processor.pay(order)
